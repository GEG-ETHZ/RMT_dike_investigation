...
%         uicontrol('Parent',uipanel_model,'style','text','string','Increase by in Y','units','normalized','Position',[188 84 116 16]./comp_p);
        ...
        H.xspacing = uicontrol('Parent',uipanel_model,'style','edit','string','0.002','backgroundcolor','white','tooltip',sprintf('Enter cell size in core mesh.'),'units','normalized','Position',[107 132 24 22]./comp_p,'Callback',@xspacing_Callback);
        H.yspacing = uicontrol('Parent',uipanel_model,'style','edit','string','0.002','backgroundcolor','white','units','normalized','Position',[137 132 24 22]./comp_p,'Callback',@yspacing_Callback); 
        H.moutcX = uicontrol('Parent',uipanel_model,'style','edit','string','18','backgroundcolor','white','units','normalized','Position',[107 108 24 22]./comp_p,'Callback',@moutcX_Callback);
        H.moutcY = uicontrol('Parent',uipanel_model,'style','edit','string','18','backgroundcolor','white','units','normalized','Position',[137 108 24 22]./comp_p,'Callback',@moutcY_Callback);
        ...
        H.firstthick = uicontrol('Parent',uipanel_model,'style','edit','string','0.5','backgroundcolor','white','units','normalized','Position',[307 132 30 22]./comp_p,'Callback',@firstthick_Callback);
        H.Zinc = uicontrol('Parent',uipanel_model,'style','edit','string','1.2','backgroundcolor','white','units','normalized','Position',[307 108 30 22]./comp_p,'Callback',@Zinc_Callback);       
        H.nl = uicontrol('Parent',uipanel_model,'style','edit','string','30','backgroundcolor','white','units','normalized','Position',[307 84 30 22]./comp_p,'Callback',@nl_Callback);       
                         
        uicontrol('Parent',uipanel_model,'style','text','string','Model Resistivity (Ohm-m)','units','normalized','Position',[5 50 100 21]./comp_p)
        H.res = uicontrol('Parent',uipanel_model,'style','edit','string','28','units','normalized','Position',[100 55 31 21]./comp_p,'Callback',@res_Callback);  
        ...
        subpanel_topo = uipanel('parent',uipanel_model,'Title','Add Topography','FontSize',8,'units','normalized','Position',[0.7 0 0.3 0.45]);
            ...
            H.airspacing = uicontrol('Parent',subpanel_topo,'style','edit','string','0.5','backgroundcolor','white','units','normalized','Position',[0.75 0.55 0.2 0.3],'Callback',@airspacing_Callback);
...
% This panel involves selecting data periods and setting error floors.
    ...
    uipanel_outputdata = uipanel('Title','4. OUTPUT DATA','FontSize',8,'units','normalized','Position',panel_p.*mp);   
        ...
        H.min_per = uicontrol('Parent',uipanel_outputdata,'style','edit','string','1e-6','backgroundcolor','white','tooltip',sprintf('Enter minimum period to be exported.\nNo periods below this value will be exported.'),'units','normalized','Position',[6 54 36 22]./comp_p,'Callback',@min_per_Callback);
        H.max_per = uicontrol('Parent',uipanel_outputdata,'style','edit','string','1e-3','backgroundcolor','white','tooltip',sprintf('Enter maximum period to be exported.\nNo periods above this value will be exported.'),'units','normalized','Position',[66 54 36 22]./comp_p,'Callback',@max_per_Callback);
        ...
        H.errflr_Zdiag = uicontrol('Parent',uipanel_outputdata,'style','edit','string','20','backgroundcolor','white','units','normalized','Position',[112 54 18 22]./comp_p,'Callback',@errflr_Zdiag_Callback);
