...
%%
    ...
    Z_new = cat(2,z_air,H.Z)-min(min(elev_grid(xpad:H.nx-xpad,ypad:H.ny-ypad)))/1000;
...
%     ind_asl = find(elev<=0);
    ind_asl = find(elev<5); % May 2020 - changed the inequality since elev is the TOP of each layer, in meters b.s.l.
